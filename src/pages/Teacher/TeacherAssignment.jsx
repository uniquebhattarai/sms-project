...
function TeacherAssignment({
  ...
  const clickAssignment = (assignment) => {
    navigate(`/${role}/assignment/details/${assignment.id}`, {
      state: { assignment },
    });
  };

  const clickhandler = () => {
    navigate(`/${role}/create/assignment`);
  };
  ...
  const getSelectedSubjectName = () => {
    const selectedSubjectObj = subjects.find(
      (subj) => subj.id === parseInt(selectedSubject)
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-transparent bg-clip-text bg-emerald-600 mb-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select
                ...
                value={selectedClass}
                className="w-full px-4 py-3 bg-white/80 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-200"
              >
...
"
              ...
              >
                {loading ? "Searching..." : "Search Assignments"}
              </button>
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-blue-100 mt-1">
                  {assignment.length > 0
                    ? `Found ${assignment.length} assignment${
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex-1">
                          ...
                          <p className="text-gray-600 mb-3 leading-relaxed">
                            {item.assignment.slice(0, 50)}.....
                          </p>
                        </div>
                        <div
                          className={`px-3 py-1 rounded-full text-sm font-medium ${deadlineStatus.color}`}
                        >
                          {deadlineStatus.text}
                        </div>
                      </div>
